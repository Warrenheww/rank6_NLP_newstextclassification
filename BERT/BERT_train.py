...
# set log format
logging.basicConfig(level=logging.INFO, filename='./log.txt',filemode='w',format='%(asctime)-15s %(levelname)s: %(message)s')
...
# some setup
test_data_file = './data/test_b.csv' # the formal testing dataset of final round
